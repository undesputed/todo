                        ...
                        <div class="form-items">
                            ...
                            <form @submit="onSubmit" class="requires-validation" novalidate>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="valid-feedback" v-if="passNotMatched">Password field is valid!</div>
                                    <div class="invalid-feedback" v-if="passNotMatched">Password field cannot be blank!
                                    </div>
                                </div>

                                <div class="col-md-12">
                                    <input class="form-control" type="password" name="password"
                                        v-model="form.confirmPassword" placeholder="Password" required>
                                    <div class="valid-feedback" v-if="passNotMatched">Password field is valid!</div>
                                    <div class="invalid-feedback" v-if="passNotMatched">Password field cannot be blank!
                                    </div>
                                </div>
